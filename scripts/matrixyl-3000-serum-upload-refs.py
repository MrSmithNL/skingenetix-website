"""Upload reference crops to fal.ai CDN so Seedream and FLUX.2 can ingest by URL.
...
REF_DIR = Path(__file__).parent.parent / "assets/images/matrixyl-3000-serum-source"
