# Page audit — `/products/acetyl-hexapeptide-8-anti-wrinkle-serum`

**Date:** 2026-09-22 · **Tool:** `scripts/page-audit.py` · **Live:** https://www.skingenetix.com/products/acetyl-hexapeptide-8-anti-wrinkle-serum
...
| | Check | Detail |
|---|---|---|
| ✅ | HTTP 200, no redirect | 200 → https://www.skingenetix.com/products/acetyl-hexapeptide-8-anti-wrinkle-serum |
| ✅ | Clean URL (lowercase, hyphens, no params, ≤ 60 chars) | /products/acetyl-hexapeptide-8-anti-wrinkle-serum |
| 🟡 | URL carries the head term | head term 'argireline' |
| ✅ | Title present, 30–60 chars | 47c: Acetyl Hexapeptide-8 Serum for Expression Lines |
| 🔴 | Title contains head term | 'argireline' |
| 🟠 | Meta description 70–160 chars | 161c |
| 🟡 | Meta description contains head term |  |
| ✅ | Indexable (no noindex) | no robots meta |
| ✅ | Self-referencing absolute canonical | https://www.skingenetix.com/products/acetyl-hexapeptide-8-anti-wrinkle-serum |
| ✅ | hreflang for all 6 locales + x-default | 7 alternates |
| ✅ | Open Graph title/description/image/url | complete |
| 🟡 | og:title matches the page title | Acetyl Hexapeptide-8 Anti-Wrinkle Serum |
| ✅ | Exactly one <h1> | Acetyl Hexapeptide-8 Anti-Wrinkle Serum |
...
| ✅ | Content images have alt text | 24/24 |
...
| ✅ | A8 · secondary intents covered on the page | ['acetyl hexapeptide-8', '10%'] / ['acetyl hexapeptide-8', '10%'] |
| ✅ | A2 · atomic paragraphs (none > 120 words) | 17 paragraphs, 0 too long |
| 🟡 | F2 · snippet-sized answer blocks (35–70 words) ≥ 3 | 1 |
...
| 🔴 | D7 · extractable text without JavaScript ≥ 600 words | 385 words extracted (main text 1265) |
...
- **H1:** ['Acetyl Hexapeptide-8 Anti-Wrinkle Serum']
...
- **Extracted words (no JS):** 385 of 1265
