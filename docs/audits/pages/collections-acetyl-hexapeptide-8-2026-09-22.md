# Page audit — `/collections/acetyl-hexapeptide-8`

**Date:** 2026-09-22 · **Tool:** `scripts/page-audit.py` · **Live:** https://www.skingenetix.com/collections/acetyl-hexapeptide-8
...
| | Check | Detail |
|---|---|---|
| ✅ | HTTP 200, no redirect | 200 → https://www.skingenetix.com/collections/acetyl-hexapeptide-8 |
| ✅ | Clean URL (lowercase, hyphens, no params, ≤ 60 chars) | /collections/acetyl-hexapeptide-8 |
| ✅ | URL carries the head term | head term '' |
| ✅ | Title present, 30–60 chars | 50c: Acetyl Hexapeptide-8 Skincare for Expression Lines |
...
| ✅ | Self-referencing absolute canonical | https://www.skingenetix.com/collections/acetyl-hexapeptide-8 |
| ✅ | hreflang for all 6 locales + x-default | 7 alternates |
| ✅ | Open Graph title/description/image/url | complete |
| 🟡 | og:title matches the page title | Acetyl Hexapeptide-8 |
| ✅ | Exactly one <h1> | Acetyl Hexapeptide-8 |
| ✅ | <h1> contains head term |  |
| ✅ | Topic headings are real <h2> (≥ 3) | 4 <h2>: ['5', '100%', '10+', 'Continue Exploring'] |
| ✅ | Visual-only headings (styled <p>/<span>) | 0 that look like headings but are not: [] |
| ✅ | No skipped heading levels | clean |
| ✅ | Content images have alt text | 8/8 |
...
| ✅ | A2 · atomic paragraphs (none > 120 words) | 0 paragraphs, 0 too long |
| 🟡 | F2 · snippet-sized answer blocks (35–70 words) ≥ 3 | 0 |
| 🟠 | A3 · fact density (measured figures ≥ 5) | 1 figures |
...
| 🔴 | D7 · extractable text without JavaScript ≥ 600 words | 31 words extracted (main text 191) |
| ✅ | Head term survives extraction |  |
| 🟠 | H2 sections survive extraction | lost: ['5', '100%', '10+', 'Continue Exploring'] |
...
| 🟠 | Section backgrounds alternate | banner+main (Bone) |
...
| | Check | Detail |
|---|---|---|
| ✅ | Opening states a concrete skin outcome | acetyl hexapeptide-8acetyl hexapeptide-8 formulations for the appearance of expression lines read what argireline does for expression lines  |
...
- **H1:** ['Acetyl Hexapeptide-8']
- **H2:** ['5', '100%', '10+', 'Continue Exploring']
- **Visual-only headings:** []
- **Schema types:** ['BreadcrumbList']
- **Extracted words (no JS):** 31 of 191

## Section map (desktop)

| Top | Height | Section | Type | Background |
|---|---|---|---|---|
| 47 | 440 | banner | collection-banner | Bone |
| 487 | 721 | main | main-collection | Bone |
| 1207 | 288 | impact_numbers | impact-text | White |
| 1495 | 579 | related_collections | image-link-blocks | Bone |
| 2074 | 0 | banner_text_width | custom-html | Bone |
| 2074 | 516 | footer | footer | Bone |
| 2590 | 0 | brand_layout_css | custom-html | Bone |
