# Page audit — `/products/copper-peptide-ghk-cu-day-gel-cream`

**Date:** 2026-09-22 · **Tool:** `scripts/page-audit.py` · **Live:** https://www.skingenetix.com/products/copper-peptide-ghk-cu-day-gel-cream
...
| | Check | Detail |
|---|---|---|
| ✅ | HTTP 200, no redirect | 200 → https://www.skingenetix.com/products/copper-peptide-ghk-cu-day-gel-cream |
| ✅ | Clean URL (lowercase, hyphens, no params, ≤ 60 chars) | /products/copper-peptide-ghk-cu-day-gel-cream |
| ✅ | URL carries the head term | head term '' |
| ✅ | Title present, 30–60 chars | 46c: Copper Peptide Day Cream 2% (GHK-Cu) Gel-Cream |
| ✅ | Title contains head term | '' |
| 🟠 | Meta description 70–160 chars | 162c |
| ✅ | Meta description contains head term |  |
| ✅ | Indexable (no noindex) | no robots meta |
| ✅ | Self-referencing absolute canonical | https://www.skingenetix.com/products/copper-peptide-ghk-cu-day-gel-cream |
| ✅ | hreflang for all 6 locales + x-default | 7 alternates |
| ✅ | Open Graph title/description/image/url | complete |
| 🟡 | og:title matches the page title | Copper Peptide (GHK-Cu) 2% Day Gel-Cream |
| ✅ | Exactly one <h1> | Copper Peptide (GHK-Cu) 2% Day Gel-Cream |
...
| ✅ | Content images have alt text | 25/25 |
...
| 🔴 | D7 · extractable text without JavaScript ≥ 600 words | 352 words extracted (main text 1400) |
...
| | Check | Detail |
|---|---|---|
| ✅ | Opening states a concrete skin outcome | zoom zoom zoom zoom zoom zoom zoom zoom zoom zoom go to item 1 go to item 2 go to item 3 go to item 4 go to item 5 go to item 6 go to item 7 |
...
- **H1:** ['Copper Peptide (GHK-Cu) 2% Day Gel-Cream']
...
- **Extracted words (no JS):** 352 of 1400
...
| 4420 | 896 | how_to_use | multi-column | White |
| 5316 | 558 | reasons_why | text-with-icons | rgb(247, 247, 247) |
| 5874 | 1343 | 17734177083a768a84 | apps | Bone |
| 7217 | 626 | related-products | product-recommendations | Bone |
| 7843 | 516 | footer | footer | Bone |
| 8359 | 0 | brand_layout_css | custom-html | Bone |
