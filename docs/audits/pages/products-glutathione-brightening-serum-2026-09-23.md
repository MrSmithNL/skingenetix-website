# Page audit — `/products/glutathione-brightening-serum`

**Date:** 2026-09-23 · **Tool:** `scripts/page-audit.py` · **Live:** https://www.skingenetix.com/products/glutathione-brightening-serum
...
| | Check | Detail |
|---|---|---|
| ✅ | HTTP 200, no redirect | 200 → https://www.skingenetix.com/products/glutathione-brightening-serum |
| ✅ | Clean URL (lowercase, hyphens, no params, ≤ 60 chars) | /products/glutathione-brightening-serum |
| ✅ | URL carries the head term | head term '' |
| ✅ | Title present, 30–60 chars | 49c: Glutathione Serum 2% with Vitamin C / Skingenetix |
| ✅ | Title contains head term | '' |
| ✅ | Meta description 70–160 chars | 148c |
| ✅ | Meta description contains head term |  |
| ✅ | Indexable (no noindex) | no robots meta |
| ✅ | Self-referencing absolute canonical | https://www.skingenetix.com/products/glutathione-brightening-serum |
| ✅ | hreflang for all 6 locales + x-default | 7 alternates |
| ✅ | Open Graph title/description/image/url | complete |
| 🟡 | og:title matches the page title | Glutathione 2% Brightening Serum |
| ✅ | Exactly one <h1> | Glutathione 2% Brightening Serum |
...
| ✅ | Internal links in content ≥ 5 | 19 unique |
...
| ✅ | A3 · fact density (measured figures ≥ 5) | 22 figures |
...
| 🔴 | D7 · extractable text without JavaScript ≥ 600 words | 426 words extracted (main text 1526) |
...
| | Check | Detail |
|---|---|---|
| ✅ | Opening states a concrete skin outcome | glutathione 2 brightening serum sale price 44 00 a brightening antioxidant serum with 2 glutathione for a brighter-looking complexion 2 glut |
| ✅ | A proof point (result %, time frame or trial size) in the first 30% of text | 4 women |
...
| ✅ | Add-to-cart present |  |
| 🟡 | Every result figure sits next to its source | 1 unsourced: ['Glutathione (2%)'] |

## Outline as served

- **H1:** ['Glutathione 2% Brightening Serum']
...
- **Extracted words (no JS):** 426 of 1526
...
| 2408 | 1098 | before_after | product-reviews-before-after | rgb(247, 245, 242) |
| 3506 | 913 | product_faq | faq | Bone |
| 4420 | 854 | how_to_use | multi-column | White |
| 5274 | 558 | reasons_why | text-with-icons | rgb(247, 247, 247) |
| 5832 | 1343 | 17734177083a768a84 | apps | Bone |
| 7175 | 626 | related-products | product-recommendations | Bone |
| 7801 | 516 | footer | footer | Bone |
| 8317 | 0 | brand_layout_css | custom-html | Bone |
