...
**▶ PHASE 2 — in progress (2026-09-22).**
...
- ⏳ **Reviewer byline** (Esther Bodde, MD, Cosmetic & Medical Physician) and `reviewedBy`/`lastReviewed` in JSON-LD — ready to add once she has read the upgraded pages.
...
- ✅ **Main menu: "Science"** (Malcolm approved 2026-09-22; this was also the original label, as "Scientific Research"). Replaces both Learn and Discover. The mega-menu has three columns: Peptides (Copper, Argireline®, Matrixyl 3000), Beyond peptides (PDRN, Glutathione) and Our approach (The Science, Ingredients, Our Philosophy). Six languages; the mega-menu was verified open in each, and the mobile drawer too. Tool `scripts/menu-apply.py`, plan `configs/menus/main-menu-science-2026-09-22.json`, `--rollback` available.
...
- ❌ **Per-study articles: not adopted.** Hairgenetix measured them (0.6 clicks/day for 9 articles, €0.40 vs €3.12 per session) and stopped. A single Evidence Library page is the alternative, parked.
