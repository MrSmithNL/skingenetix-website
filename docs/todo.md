...
**Priority:** 🔴 Phase 1 done (2026-09-22), Phase 2 done (2026-09-23, all five hubs to the research-page standard); Phase 3 (the spokes) is next
...
- ⏭ **Argireline: the rest of its parity** — a ten-row evidence table from its register and image rows for the usage text (the register's §2 table is ready to grade).
