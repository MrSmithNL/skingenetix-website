...
- 🛑 **Decision for Malcolm: main-menu label.** Recommended: replace **both** "Learn" and "Discover" with **"Science"**, and group the mega-menu into Peptides / Beyond peptides. **Not "Peptides"**, because PDRN (the flagship) is not a peptide. Full reasoning: `docs/decision-citations-study-pages-navigation-2026-09-22.md` §1.
